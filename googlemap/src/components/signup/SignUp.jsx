        ...
        <Box className={classes.subcontainer2}>
          <Box className={classes.mains}>
            ...
            <Box className={classes.form}>
              ...
              <Box><TextField className={classes.fnametext} onChange={takeFirstname} error={regexObj.firstnameBorder} helperText={regexObj.firstnameHelper} className={classes.fnametext} sx={{ width: 430 }} label='Firstname' variant="outlined" size="small" /></Box>
              <Box className={classes.texttitle}>LASTNAME</Box>
              <Box><TextField className={classes.lnametext} onChange={takeLastname} error={regexObj.lastnameBorder} helperText={regexObj.lastnameHelper} className={classes.lnametext} sx={{ width: 430 }} label='Lastname' variant="outlined" size="small" /></Box>
              <Box className={classes.texttitle}>USERNAME</Box>
              <Box><TextField className={classes.unametext} onChange={takeUsername} error={regexObj.usernameBorder} helperText={regexObj.usernameHelper} className={classes.unametext} sx={{ width: 430 }} label='Username' variant="outlined" size="small" /></Box>
              <Box className={classes.texttitle}>PASSWORD</Box>
              <Box><TextField className={classes.passwordtext} onChange={takePassword} error={regexObj.passwordBorder} helperText={regexObj.passwordHelper} className={classes.passwordtext} sx={{ width: 430 }} label='Password' variant="outlined" size="small" /></Box>
              <Box >
